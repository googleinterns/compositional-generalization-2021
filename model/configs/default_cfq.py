...
def get_config():
  ...
  config.copy_input_in_full = True
  ...
  config.checkpoint_every_steps = 6_000
  # Frequency of eval during training, e.g. every 1000 steps.
  config.eval_every_steps = 6_000
